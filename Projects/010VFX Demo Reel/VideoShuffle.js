...
function ShufflePlayer(vSources, aSources, vSourceDurations, aSourceDurations, autostart, shufflevideosources, shuffleaudiosources){
    ...
    this.vswrapper.innerHTML = "\
        ...
        <div id='VideoShuffleInfo'>\
            ...
            <article>\
                ...
                <p>Code by <a href='http://www.MadisonAster.com'>Madison Aster</a> available on <a href='http://github.com/MadisonAster/VideoShuffle'>GitHub</a>.</p>\
            </article>\
        </div>\
    ...
    this.loadVideos = function() {
        ...
        for (i = 0; i < this.videoSources.length; i++) {
            ...
            button.style.backgroundImage = 'url("'+this.videoSources[i].replace('.mp4', '.jpg').replace('./Projects/', './_testing/Projects/')+'")';
            console.log(this.videoSources[i].replace('.mp4', '.jpg').replace('./Projects/', './_testing/Projects/'));
            console.log(button);
