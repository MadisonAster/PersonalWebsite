...
function CVContactDetails(doc, PositionTitle) {
    ...
    doc.addImage(imgData1, 'JPEG', 1, 220, 178, 100);
    doc.addImage(imgData1, 'JPEG', 1, 362, 178, 100);
    doc.addImage(imgData1, 'JPEG', 1, 504, 178, 100);
    doc.addImage(imgData1, 'JPEG', 1, 646, 178, 100);
}
