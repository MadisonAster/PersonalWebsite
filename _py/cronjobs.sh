...
20 01 * * * firefox -P headless -headless --first-startup >> /mnt/w/_logs/firefox.log 
30 01 * * * pkill -f firefox
31 01 * * * python3 /mnt/w/_py/Firefox.py /moz-headless Favorites/Bookmarks/snapshot/ >> /mnt/w/_logs/cron_Bookmarks.log
