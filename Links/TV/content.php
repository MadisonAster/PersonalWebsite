...
foreach ($TVdirs as &$dir){
    if(!in_array($dir, $blacklist)){
        ...
        echo "    <img src='_Assets/ImgPlaceHolder.png' rsrc='$dir/thumb.jpg'></img>\n";
        ...
        echo "    <img src='_Assets/ImgPlaceHolder.png' rsrc='$dir/thumb.jpg' data-original='$dir/thumb.jpg'></img>\n";
        echo "    <br/>\n";
        echo "    <div style='width:150px;height:80px;text-align:center;color:#FFFFFF;text-shadow: 2px 2px 0px rgba(0, 0, 0, 1.0);'>\n";
        echo "    $movieName\n";
        echo "    </div>\n";
