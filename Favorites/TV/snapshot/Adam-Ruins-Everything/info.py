{'Actors': [],
 ...
 'Countries': ['USA'],
 'Description': '\n'
                'Adam Ruins Everything: Adam Conover from CollegeHumor turns '
                'life as we know it on its ear by showing us how unnecessary, '
                'and sometimes horrible, things we think we know to be real '
                'and true really are. ',
 'Director': ['NA'],
