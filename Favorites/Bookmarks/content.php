        ...
        if (strpos($folder['_title'], '|') !== false) {
            ...
            echo "<div class='clickable'>";
                echo "<div class='clickable' style='padding:0;margin:0;'>";
                    ...
                    echo "<p class='clickable' style='margin:0;width:50%;float:right;text-align:right;'><span style='color:#3f3f3f;'>Skill Level</span> ".$level."  <span style='color:#3f3f3f;'>|</span>  ".$year."</p>";
                echo "</div>";
