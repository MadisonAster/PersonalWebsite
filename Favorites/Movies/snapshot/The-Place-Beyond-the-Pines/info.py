{'@context': 'http://schema.org',
 ...
 'review': {'@type': 'Review',
            ...
            'itemReviewed': {'@type': 'CreativeWork',
                             'url': '/title/tt1817273/'},
            'name': 'Great',
            'reviewBody': "This is one of Gosling's older films that is just "
                          'raw and beautiful. Two stories colliding into one. '
                          "The pacing can be slow but it'll still keep you "
                          'engaged all the way.',
