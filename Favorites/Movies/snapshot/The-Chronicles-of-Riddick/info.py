{'Actors': ['Aaron Douglas',
 ...
 'Countries': ['USA'],
 'Description': '\n'
                'The Chronicles of Riddick: 5 years after Pitch Black, the '
                'wanted criminal Riddick arrives on a planet called Helion '
                'Prime, and finds himself up against an invading empire called '
                'the Necromongers, an army that plans to convert or kill all '
