<?php
$infoArray = array('Actors' => array('Adam Clark',
            'Alison Lohman',
            'Beth Grant',
            'Bill Saito',
            'Bruce Altman',
