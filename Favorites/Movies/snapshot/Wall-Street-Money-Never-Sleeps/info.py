{'Actors': ['Alex Revan',
 ...
 'Countries': ['USA'],
 'Description': '\n'
                'Wall Street Money Never Sleeps: As the global economy teeters '
                'on the brink of disaster, a young Wall Street trader partners '
                'with disgraced former Wall Street corporate raider Gordon '
                'Gekko on a two-tiered mission: To alert the financial '
                'community to the coming doom, and to find out who was '
