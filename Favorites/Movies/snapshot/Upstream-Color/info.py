{'Actors': ['Andrew Sensenig',
 ...
 'Countries': ['USA'],
 'Description': '\n'
                'Upstream Color: A man and woman are drawn together, entangled '
                'in the life cycle of an ageless organism. Identity becomes an '
                'illusion as they struggle to assemble the loose fragments of '
                'wrecked lives. ',
