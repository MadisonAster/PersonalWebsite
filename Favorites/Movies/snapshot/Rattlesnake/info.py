{'@context': 'http://schema.org',
 ...
 'name': 'Rattlesnake',
 'review': {'@type': 'Review',
            'author': {'@type': 'Person', 'name': 'Draysan-Jennings'},
            'dateCreated': '2019-10-28',
            'inLanguage': 'English',
            'itemReviewed': {'@type': 'CreativeWork',
                             'url': '/title/tt9257484/'},
            'name': 'Not totally unwatchable',
            'reviewBody': "I've sat through a lot worse. Movie really didn't "
                          'go anywhere. Was decent background noise with '
                          "minimal story line. I guess if you can't find "
                          'anything else to watch give it a shot.',
