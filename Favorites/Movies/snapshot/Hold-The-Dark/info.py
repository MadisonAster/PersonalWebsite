{'@context': 'http://schema.org',
 ...
 'name': 'Hold the Dark',
 'review': {'@type': 'Review',
            'author': {'@type': 'Person', 'name': 'anna_oddi'},
            'dateCreated': '2018-10-01',
            'inLanguage': 'English',
            'itemReviewed': {'@type': 'CreativeWork',
                             'url': '/title/tt5057140/'},
            'name': 'sometimes wolves.. nothing happening.. nothing '
                    'happening.. people getting shot.. nothing happening.. the '
                    'end',
            'reviewBody': 'The worst movie i have ever seen in my life.  '
