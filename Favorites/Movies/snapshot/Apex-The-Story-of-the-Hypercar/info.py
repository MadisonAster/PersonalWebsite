{'Actors': ['Chris Harris'],
 ...
 'Countries': ['USA'],
 'Description': '\r\n'
                '              Apex The Story of the Hypercar: "APEX: The '
                'Story of the Hypercar" spotlights a new class of exotic '
                'sports cars designed to blast from zero to 200 miles per hour '
                'in seconds. Rocket science meets the auto industry as '
                '"APEX"...            ',
 'Director': ['JF Musial'],
