{'EntryAdded': '06-05-2020',
 ...
 'description': '<p>GAME-PLAY ALERT: This game has been fully tested to '
                ...
                'cases, you may see some minor irregularities with audio/video '
                'for brief periods. For more details, see '
                'www.xbox.com/xboxoriginals. Halo® is a sci-fi shooter that '
                'takes place on a mysterious alien ring-world. Packed with '
                'combat, Halo will have you battling on foot, in vehicles, '
                'inside and outdoors with Alien and Human weaponry. Your '
                'objective: to uncover Halo&#39;s horrible secrets and destroy '
                'mankind&#39;s sworn enemy, the Covenant. There are no refunds '
                'for this item. For more information, see '
                'www.xbox.com/live/accounts.</p>',
