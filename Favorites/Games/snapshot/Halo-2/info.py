{'EntryAdded': '06-05-2020',
 ...
 'description': '<p>The Covenant alien race threatens to destroy all '
                ...
                'Chief, a genetically enhanced supersoldier. Master Chief '
                'returns in Halo 2, which features new vehicles, weapons, '
                'environments, and more. This time, you can interact with your '
                'environment, wield two weapons at the same time, board '
                'opponents&#39; vehicles, and even switch sides to play the '
                'role of a Covenant Elite. Halo 2 also supports broadband '
                'multiplayer action via Xbox Live.</p>',
