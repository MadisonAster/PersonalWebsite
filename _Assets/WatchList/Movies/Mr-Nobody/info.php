<?php
$infoArray = array('Actors' => array('Allan Corduner',
            'Andrew Simms',
            'Bill Corday',
            'Brian Wrench',
            'Carlo Mestroni',
