...
docker tag $myapache_image_id $aws_user_id.dkr.ecr.$aws_region.amazonaws.com/rpp_myapache-service
docker push $aws_user_id.dkr.ecr.$aws_region.amazonaws.com/rpp_myapache-service